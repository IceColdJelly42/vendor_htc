...
PRODUCT_COPY_FILES += \
  ...
  $(LOCAL_PATH)/proprietary/bin/iw:system/bin/iw \
  ...
  $(LOCAL_PATH)/proprietary/etc/firmware/ti-connectivity/wl128x-fw-4-plt.bin:system/etc/firmware/ti-connectivity/wl128x-fw-4-plt.bin \
  ...
  $(LOCAL_PATH)/proprietary/lib/hw/vendor-camera.tegra.so:system/lib/hw/vendor-camera.tegra.so \
